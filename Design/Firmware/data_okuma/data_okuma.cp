#line 1 "C:/Users/Burak/Desktop/SyncBox Kodlarý/data_okuma/data_okuma.c"
int row = 1;
int col = 1;
...
unsigned char deneme1[64];
unsigned char deneme2[64];
unsigned char deneme3[64];
unsigned char deneme4[64];
...
while(!HID_Write(&writebuff,datacnt));
 ...
 deneme1[cnt-1]= readbuff[cnt];

 UART1_Write_Text(&deneme1);
 ...
 deneme2[cnt-1]= readbuff[cnt];

 UART1_Write_Text(&deneme2);
 ...
 deneme3[cnt-1]= readbuff[cnt];

 UART1_Write_Text(&deneme3);
 ...
 deneme4[cnt-1]= readbuff[cnt];

 UART1_Write_Text(&deneme4);
